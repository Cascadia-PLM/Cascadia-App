          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2 space-y-6">
              <Card>
                ...
                <CardContent>
                  <dl className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <ViewEditText
                      label="Item Number"
                      value={isEditing ? software.itemNumber : current.itemNumber}
              ...
              <Card>
                ...
                <CardContent>
                  <dl className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <ViewEditSelect
                      label="Source Mode"
                      value={isEditing ? software.sourceMode : current.sourceMode}
              ...
              <Card>
                ...
                <CardContent>
                  <ViewEditTextarea
                    label=""
                    value={isEditing ? software.description : current.description}
            ...
            <div className="space-y-6">
              ...
              {isEditing ? (
                ...
                <Card>
                  <Collapsible
                    defaultOpen={Object.keys(current.attributes ?? {}).length > 0}
                  >
