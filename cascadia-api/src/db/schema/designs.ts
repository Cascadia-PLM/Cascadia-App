...
// The configuration shape lives in commons beside the row it is a column of;
// re-exported so schema callers keep importing it from here.
...
/** Pins the hand-written wire row in commons to this table. */
export type _DesignRowMatches = Expect<
  Equal<typeof designs.$inferSelect, DesignRow>
>
