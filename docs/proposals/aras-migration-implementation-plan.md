...
**Status**: Not started. None of the phases below have begun; no migration code
exists in the repo. Companion to
[aras-migration-tool-scope.md](./aras-migration-tool-scope.md).
...
**Output**: `packages/core/src/lib/items/types/part.ts`
...
**Output**: `packages/core/src/lib/items/forms/PartForm.tsx`
