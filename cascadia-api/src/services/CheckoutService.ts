...
// The wire shape lives in commons so the web can name it; the row type is
// bound here, where the schema is.
export type CheckoutStatus = CheckoutStatusWire<typeof branchItems.$inferSelect>
