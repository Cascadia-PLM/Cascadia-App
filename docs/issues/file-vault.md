...
- **Location**: `packages/core/src/lib/vault/utils/file-utils.ts` lines 282-308
...
- **Location**: `packages/core/src/lib/vault/services/FileService.ts` lines 139-155
...
- **Location**: `packages/core/src/lib/vault/storage/storage-factory.ts` line 82, `packages/core/src/lib/vault/storage/types.ts` line 65
